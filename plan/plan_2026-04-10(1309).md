...
작성일: 2026-04-10 / 버전: 1.1  
참조 명세서: `req/req_2026-04-10(1230).md`  
이전 버전: `plan_2026-04-10(1230).md`

> **v1.1 변경 사항 요약**
> - 휴지통 구현 방식 확정 (OS IS_TRASHED 활용, 앱 자체 삭제 미수행)
> - Room DB trash 테이블 제거 (불필요)
> - Android 14 부분 사진 접근 지원 제외 확정
> - 즐겨찾기 식별자: URI 기반 확정 + 주의사항 명시
> - 핀치 줌 가상 뷰: 저해상도 썸네일로 확정
> - 앨범 뷰 서랍 트리거: 스와이프 제스처 확정
> - 다중 선택 모드: 롱프레스 확정
> - 미구현 메뉴 탭 동작: 토스트 메시지 확정
> - 앱 정보 확정: 이름 `갤러리`, 패키지명 `com.yoshi0311.gallery`
> - Google Maps API Key 관리 방식 결정: `secrets-gradle-plugin`
> - 미확인 사항 체크리스트 대부분 해소
